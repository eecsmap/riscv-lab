...
// E1: the ONLY intended difference from the frozen B0 inputs. 25.0 -> 40.0 takes the MMCM from
// 125 MHz x8/25 = 40 MHz to 125 MHz x8/40 = 25 MHz. Nothing else in this file or any other input is
// changed; the original value and its commentary are preserved above.
